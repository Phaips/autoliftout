...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout_4.addWidget(self.comboBox_detection_type, 2, 0, 1, 2)
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_4.addItem(spacerItem, 15, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.pushButton_continue, 16, 0, 1, 2)

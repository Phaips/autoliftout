...
```
conda create -n fibsem python=3.6 pip
...
## Install `liftout`
Download the latest `liftout` release wheel from https://github.com/DeMarcoLab/liftout/releases

Pip install the wheel file (`.whl`) into your python virtual environment.
```
conda activate fibsem
pip install $LIFTOUT_WHEEL_FILENAME.whl
```
